...
permalink: '/2016/06/25/scraping-web-pages-in-labview/'
...
import LiteYoutube from '../../components/lite-youtube.astro';

# {frontmatter.title}

I made a video showing how! Well, I made it <HoverHint hint="Some might even call it months...">several weeks ago...</HoverHint>

<LiteYoutube videoid="T-j1cvgNJ1I" description="Example of Scraping Web Pages in LabVIEW"></LiteYoutube>
...
<img width="640" height="509" src="/assets/scraping/weather_inspect_element.gif" />
...
<img width="733" height="286" src="/assets/scraping/weather_underground_api.png" />
...
- The web service requires user login, i.e. <HoverHint hint="Telling the service who you are or who you represent">Authentication</HoverHint> and <HoverHint hint="Figuring out what you can do or requesting something to do">Authorization.</HoverHint>
